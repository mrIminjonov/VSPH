...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const jobTitles = ["Software Engineer", "Data Scientist", "Doctor", "Teacher", "Designer"];
    const degrees = ["Bachelor's", "Master's", "PhD", "DcS"];
    ...
    registerForm.addEventListener('submit', function(event) {
        ...
        console.log('Registration attempt with data:', userData); // Log the registration attempt
